...
using tags that describe what they are surrounding

2. Name two big differences between ```display: block;``` and ```display: inline;```.

block takes up the whole line,pushing the next tag to a new line. while inline only takes up the space it needs.

3. What are the 4 areas of the box model?

margin, border, padding, words/item.
...
it allows multiple people to work on the same project at once and any changes made not to be permanent. this makes it easier to debug a program.
